...
- **Roteiro de leituras:**
   ...
   - **TODO 2.4 (P2):** Ler capítulos 6 do tutorial do ns-3 e trazer dúvidas para discutir em reunião;
      ...
      - **Material Complementar:** an in-depth coverage of the architecture and core of ns-3 [Manual do ns-3](https://www.nsnam.org/docs/release/3.33/manual/ns-3-manual.pdf)
      - Todo esse material pode ser encontrado em [https://www.nsnam.org/releases/ns-3-33/documentation/](https://www.nsnam.org/releases/ns-3-33/documentation/)
   - **TODO 2.5 (P3):** Fazer e entender o exemplo first.cc (acompanhar a leitura no [Tutorial ns-3](https://www.nsnam.org/docs/release/3.33/tutorial/ns-3-tutorial.pdf)), ver as apresentações do minicurso de cada exemplo. O minicurso está na pasta ```<GoogleDrive>/GppCom_Entrance_Training\technical_material\books>```.
   ...
   - **TODO 2.7:** Fazer e entender os exemplos third.cc até seventh.cc (acompanhar a leitura no [Tutorial ns-3](https://www.nsnam.org/docs/release/3.33/tutorial/ns-3-tutorial.pdf)), ver as apresentações do minicurso de cada exemplo. O minicurso está na pasta ```<GoogleDrive>/GppCom_Entrance_Training\technical_material\books>```. 
   - **TODO 2.8:** Hands-on 03: Desafios relacionados ao exemplo third.cc [link](https://github.com/vicentesousa/ns3-intermediate-training)
   -  **TODO 2.9:** Hands-on 04: Desafios relacionados ao exemplo third.cc parte 2 [link](https://github.com/vicentesousa/ns3-intermediate-training)
   -  **TODO 2.10:** Hands-on 05: Desafios relacionados ao exemplo fifth.cc [link](https://github.com/vicentesousa/ns3-intermediate-training)
